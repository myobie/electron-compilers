...
var BabelCompiler = function (_CompilerBase) {
  ...
  _createClass(BabelCompiler, [{
    ...
    value: function attemptToPreload(names, prefix) {
      var fixupModule = function fixupModule(exp) {
      ...
      var preloadStrategies = [function () {
        return names.map(function (x) {
          return fixupModule(require.main.require('babel-' + prefix + '-' + x));
        });
      }, function () {
        var nodeModulesAboveUs = _path2.default.resolve(__dirname, '..', '..', '..');
        return names.map(function (x) {
          return fixupModule(require(_path2.default.join(nodeModulesAboveUs, 'babel-' + prefix + '-' + x)));
        });
      }, function () {
        return names.map(function (x) {
          return fixupModule(require('babel-' + prefix + '-' + x));
        });
      }];
    ...
    key: 'compile',
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(sourceCode, filePath, compilerContext) {
        var opts, plugins, presets;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                console({ babel: true, filePath: filePath });
    ...
    value: function compileSync(sourceCode, filePath, compilerContext) {
      ...
      var opts = Object.assign({}, this.compilerOptions, {
        filename: filePath,
        ast: false,
        babelrc: false
      });
