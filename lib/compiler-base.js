...
var CompilerBase = exports.CompilerBase = function () {
  ...
  _createClass(CompilerBase, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(sourceCode, fileName, compilerContext) {
    ...
    key: "compile",
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(sourceCode, fileName, compilerContext) {
...
var SimpleCompilerBase = exports.SimpleCompilerBase = function (_CompilerBase) {
  ...
  _createClass(SimpleCompilerBase, [{
    key: "shouldCompileFile",
    value: function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(fileName, compilerContext) {
    ...
    key: "determineDependentFiles",
    value: function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(sourceCode, filePath, compilerContext) {
    ...
    key: "compile",
    value: function () {
      var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(sourceCode, filePath, compilerContext) {
