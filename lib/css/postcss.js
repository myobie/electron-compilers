...
var PostCSSCompiler = function (_CompilerBase) {
  ...
  function PostCSSCompiler() {
    ...
    console.dir({ compilerOptions: _this.compilerOptions });
  ...
  _createClass(PostCSSCompiler, [{
    ...
    value: function shouldCompileFile(fileName, compilerContext) {
      console.dir({ shouldCompileFile: true, fileName: fileName });
      return true;
    }
  }, {
    ...
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(sourceCode, filePath, compilerContext) {
        var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, pluginName, plugin, thisPath, paths, opts, result;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                for (_iterator = this.compilerOptions.plugins[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        }, _callee, this, [[1, 36], [8, 12, 16, 24], [17,, 19, 23]]);
      }));
