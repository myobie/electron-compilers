...
var d = require('debug-electron')('electron-compile:inline-html');
...
var InlineHtmlCompiler = function (_CompilerBase) {
  ...
  _createClass(InlineHtmlCompiler, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(fileName, compilerContext) {
    ...
    value: function () {
      var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(sourceCode, filePath, compilerContext) {
    ...
    key: 'each',
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(nodes, selector) {
        var acc;
    ...
    key: 'compile',
    value: function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(sourceCode, filePath, compilerContext) {
        var _this2 = this;
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                console.log({ inline: true, filePath: filePath });
                ...
                toWait.push(this.each($('style'), function () {
                  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(i, el) {
                ...
                toWait.push(this.each($('script'), function () {
                  var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(i, el) {
    ...
    value: function compileSync(sourceCode, filePath, compilerContext) {
      ...
      this.eachSync($('style'), function () {
        var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(i, el) {
          var mimeType, thisCtx, origText, newText;
      ...
      this.eachSync($('script'), function () {
        var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(i, el) {
    ...
    value: function getCompilerVersion() {
      ...
      var compilers = this.allCompilers || [];
      var otherVersions = compilers.map(function (x) {
    ...
    value: function createFromCompilers(compilersByMimeType) {
      ...
      var compileBlock = function () {
        var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(sourceCode, filePath, mimeType, ctx) {
